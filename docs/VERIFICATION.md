...
- Release 1A remains in measurement mode. Its definition of done still requires at least 50 owner decisions over at least 14 days, a 20% median time-to-decision improvement from the Release 0 baseline, and no increase in missed actionable decisions. Automatic tiered model analysis remains disabled until the seven-day usage-instrumentation shadow period is complete; current model recommendations come only from on-demand coordinator proposals.
